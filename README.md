...
dependencies {
    ...
    implementation 'com.combateafraude.sdk:passive-face-liveness:5.25.5'
...
dependencies:  
  passive_face_liveness:
    git:
      url: https://github.com/combateafraude/Flutter.git
      ref: passive-face-liveness-compatible-v5.0.0-rc03
```
...
| `bool useDebug`<br><br>Permite o uso do app em modo debug quando `true`. Recomendamos desabilitar o uso desses dispositivos por questões de segurança. O padrão é `False` |
